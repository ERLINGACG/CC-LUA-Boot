...
function Example_f()
    ...
    Son_windows=UILib.CreatWindow(RootWindows,10,10,300,180)
    UILib.SHOW(Son_windows,gpu.ColorRGB.yellow)
        ...
        function TOUCH_TEST1()
            UILib.DrawText(Son_windows,10,10,"Touch Test1",gpu.ColorRGB.white,gpu.ColorRGB.black,1)
        end
        TEXT_TABLE={
            "From1",
            "From2",
        ...
        -- UILib.Button(Son_windows,60,60,65,65,30,30,"Button",gpu.ColorRGB.white,gpu.ColorRGB.white,gpu.ColorRGB.white,gpu.ColorRGB.black,1,FLAP_L,false,TOUCH_TEST1)
        CON_TABLE={
            t1=FLAP_L,
            t2=true
        }
        FUNC_TABLE={
            t1=function()UILib.DrawText(Son_windows,100,100,"Test1",gpu.ColorRGB.white,gpu.ColorRGB.black,1)end,
            t2=function()print("t2")end
        }
        UILib.CreateFrom(Son_windows,5,10,100,20,TEXT_TABLE,1,gpu.ColorRGB.black,gpu.ColorRGB.white,gpu.ColorRGB.white,gpu.ColorRGB.black,false,CON_TABLE,FUNC_TABLE)
        UILib.CreateFrom(Son_windows,105,10,100,20,TEXT_TABLE,1,gpu.ColorRGB.black,gpu.ColorRGB.white,gpu.ColorRGB.white,gpu.ColorRGB.black,false,CON_TABLE,FUNC_TABLE)
        UILib.CreatNarbar(Son_windows,5,120,40,20,TEXT_TABLE2,1,gpu.ColorRGB.black,gpu.ColorRGB.white,gpu.ColorRGB.white,gpu.ColorRGB.black,false,CON_TABLE,FUNC_TABLE)
        UILib.CreatNarbar(Son_windows,5,140,40,20,TEXT_TABLE2,1,gpu.ColorRGB.black,gpu.ColorRGB.white,gpu.ColorRGB.white,gpu.ColorRGB.black,false,CON_TABLE,FUNC_TABLE)
        -- Level()
    -- 刷新窗口 --
